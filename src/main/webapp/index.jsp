...
<header>
    ...
    <div id="headerlogo">
        <img src="img/logoB.png" height="100px" width="100px">
...
<content>
    ...
    <div id="contentrightQC">
        <marquee id="moveproductsale" onmouseover="this.stop()" onmouseout="this.start()" behavior="scroll"
                 direction="down" height="2000px">
