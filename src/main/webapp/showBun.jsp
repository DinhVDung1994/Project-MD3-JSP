...
<content>
    ...
    <div id="contentright">
        <div id="productFoods">
            <c:forEach items="${listMonGa}" var="sp">
                <div class="product">
    ...
    <div id="contentrightQC">
        ...
        <c:forEach items="${listMonGa}" var="spd">
            <div class="productDrink">
                <div><img src="${spd.imgProductFood}" width="250px" height="200px"></div>
                <div>${spd.nameProductFood}</div>
                <div>${spd.priceProductFood}</div>
                <div><input type="submit" value="Thêm Vào Giỏ Hàng"></div>
            </div>
        </c:forEach>
